...
<?php 
	...
	if(isset($_POST['submit'])){
		for($x = 1; $x <=7; $x++){
			$break_val = $_POST["break_val_".$x.""];
			$lunch_val = $_POST["lunch_val_".$x.""];
			$supper_val = $_POST["supper_val_".$x.""];
			$dinner_val = $_POST["dinner_val_".$x.""];
  ...
  <table class="table table-bordered">
	...
	?>
      <tr>
        ...
        <td><input type="text" class="form-control" name="break_val_<?php echo $week_id; ?>"></td>
		<td><input type="text" class="form-control" name="lunch_val_<?php echo $week_id; ?>"></td>
		<td><input type="text" class="form-control" name="supper_val_<?php echo $week_id; ?>"></td>
		<td><input type="text" class="form-control" name="dinner_val_<?php echo $week_id; ?>"></td>
      </tr>
		<?php } ?>
